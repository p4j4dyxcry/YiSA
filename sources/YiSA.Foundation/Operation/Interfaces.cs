...
namespace YiSA.Foundation.Operation
{
    ...
    public interface IDisposableOperation : IOperation, IDisposable
    {
        void BindOperator(IOperator @operator);
    }
    ...
    public class EmptyMergeJudge : IMergeJudge
    {
        public bool CanMerge(IMergeJudge operation)
        {
            return false;
        }
